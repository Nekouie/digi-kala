        ...
        <div className="w-full px-5 flex flex-row justify-between items-start mt-10">
            ...
            <div className="flex flex-col">
                ...
                <div className="flex flex-row justify-between">
                    <input className="bg-gray-200 p-4 w-full me-2 caret-red-600 caret outline-0  placeholder:text-gray-400/75 placeholder:font-mono placeholder:text-lg rounded-lg" type="email" placeholder="ایمیل شما"/>
