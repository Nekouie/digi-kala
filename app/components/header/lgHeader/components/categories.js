...
const Categories = () => {
    return (
        <>
            <div className="w-fit max-w-3/4 flex flex-row items-end mt-2 justify-between">
                <div className="w-f  flex flex-row justify-start items-center">
                    ...
                    <span className="text-gray-200">|</span>
                    <div className="relative flex justify-center items-center px-2 py-4 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 after:bg-red-600 hover:after:w-full
                    after:transition-all after:duration-200 not-hover:duration-1100">
                        <Link href={"/"}
