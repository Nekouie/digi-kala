            ...
            <div
                ...
                <div className="w-full pt-5 h-20 flex flex-row justify-between items-center">
                    ...
                    <div
                        ...
                        <p className="text-gray-400 text-xs font-[500]"> بازگشت به بالا</p>
                        <ExpandLess className="text-gray-400 scale-85" />
                    </div>
